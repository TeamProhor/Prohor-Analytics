...
export const AUTH_TOKEN = 'prohor.auth';
export const LOCALE_CONFIG = 'prohor.locale';
export const TIMEZONE_CONFIG = 'prohor.timezone';
export const DATE_RANGE_CONFIG = 'prohor.date-range';
export const THEME_CONFIG = 'prohor.theme';
export const CURRENCY_CONFIG = 'prohor.currency';
export const DASHBOARD_CONFIG = 'prohor.dashboard';
export const LAST_TEAM_CONFIG = 'prohor.last-team';
export const SHARE_TOKEN_HEADER = 'x-prohor-share-token';
export const SHARE_CONTEXT_HEADER = 'x-prohor-share-context';
export const HOMEPAGE_URL = 'http://localhost:3000';
export const DOCS_URL = 'https://github.com/prohor-analytics/prohor-analytics';
export const REPO_URL = 'https://github.com/prohor-analytics/prohor-analytics';
