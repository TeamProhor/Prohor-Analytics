...
export function App({ children }) {
  ...
  return (
    ...
    >
      ...
      {process.env.PROHOR_SELF_TRACK && (
        <Script
          async
          data-website-id={process.env.PROHOR_SELF_TRACK}
          src={`${process.env.basePath || ''}/script.js`}
          data-cache="true"
          data-performance="true"
        />
      )}
      {process.env.PROHOR_SELF_RECORD && (
        <Script
          async
          data-website-id={process.env.PROHOR_SELF_RECORD}
          data-sample-rate="1"
