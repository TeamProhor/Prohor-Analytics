...
export function WebsiteData({
  ...
  return (
    <Column gap="6">
      {!isAdmin && (
        <ActionForm
          label={t(labels.transferWebsite)}
          description={t(messages.transferWebsite)}
        >
          <DialogTrigger>
            <Button isDisabled={!canTransferWebsite}>
              {t(labels.transfer)}
            </Button>
            <Modal>
      ...
      <ActionForm
        label={t(labels.resetWebsite)}
        description={t(messages.resetWebsiteWarning)}
      >
        <DialogTrigger>
